...
| Monetization | x402 protocol (ERC-402 payment headers) |
...
# Compile & test contracts (13 tests)
...
Currently deployed on X Layer testnet (Chain ID 1952). Contracts are audited by the test suite (13/13 passing) but not externally audited. Do not use with real funds.
</details>
